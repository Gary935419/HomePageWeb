...
<body style="background: #fff;">
	...
	<div id="wrapper">
        ...
        <div class="seminar_t_box">
            <div class="img"><img src="{{ asset('assets/web_img/seminar/t01.png') }}" alt=""></div>
            <div class="seminar_t_txt">
                ...
                <dl>
                    <dt>専門分野</dt>
                    <dd>アルコール・インターロック法制度、運輸安全法令、アルコール検知器</dd>
                </dl>
                <dl>
                    <dt>経歴・資格</dt>
                    <dd>静岡県安全運転管理者講習　委嘱講師 / 運行管理者（貨物・旅客）</dd>
                </dl>
                <dl>
                    <dt>セミナー実績</dt>
                    <dd>200回</dd>
            ...
            <div class="seminar_t_fot_txt">
                <p class="txt">静岡県の安全運転管理者向け講習で、飲酒運転防止インストラクターとして企業におけるアルコール教育の手法と啓発を10年以上やっています。運輸事業者向けでは点呼制度や運行管理のデジタル化等のセミナーを担当。運輸安全Journalの編集長。</p>
            </div>
        </div>
