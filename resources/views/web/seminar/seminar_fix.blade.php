...
<script src="{{ asset('assets/web_js/colorbox/colorbox.min.js') }}"></script>
<script>
...
<body>
	...
	<div id="wrapper">
            ...
            <div class="page_ttl_wrap">
                <div class="page_ttl_inner">
                    ...
                    <ul class="pan">
                        ...
                        <li><a href="/seminar/">セミナー・展示会情報</a></li>
                        <li><span>開催終了</span></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <section class="area">
            <div class="inner">
               <h3 class="page_ttl_sub"><span>開催終了</span></h3>
               ...
               <div class="seminar_page_wrap">
                ...
                <div class="go_back go_back_b_none txt_center"><a href="/seminar">セミナー・展示情報へ戻る</a></div>
